...
If you are seeking to be added to the [Moroccoswap.tech](https://moroccoswap.tech/) exchange, you should open a [listing request issue](https://github.com/AntikyetheraLans/moroccoswapfrontendamm/issues/new?assignees=Chef-Chungus&labels=listing&template=listing-request.md&title=%5BListing%5D+Request+listing+for+%7BADD+TOKEN+NAME+HERE%7D). Someone from the team will review your application. Once it's validated, you can jump to the mext step.

## Adding Tokens

1. Fork the [Morocco Interface](https://github.com/AntikytheraLabs/moroccoswapfrontendamm/) repository on GitHub
